...
const findFourth = (numbers) => numbers[4]
...
// ANSWER: Yes. While the second function uses much less space they are still both O(n)
...
// ANSWER: The first function is str + splitstr + (size of letters object) ==> 2(str) + const ==> str ==> O(n)
//         The second function is str - (nonalpha chars) + (size of letters object) ==> str + const ==> str ==> O(n)
